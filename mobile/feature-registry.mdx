...
Launch treats major product capabilities (auth/session, payments, etc.) as **features** that can be enabled/disabled and composed centrally.
...
As the template evolves, each feature should also declare:

- the screens/routes it contributes
- required permissions (notifications, camera, etc.)
- required backend endpoints and env vars
