...
The Launch mobile app uses [Better Auth](https://better-auth.com) with Expo
integration for a secure, seamless authentication experience. This guide
explains how authentication works in the mobile client and how it connects to
the API.
...
1. Configure auth providers in the API: [Backend Authentication Setup](/authentication/backend-setup)
...
Sessions are stored in SecureStore, OAuth redirects use the `launch://` scheme,
and device metadata is attached to auth requests for tracing and support.

## Next Steps

- [Apple Sign-In Setup](/authentication/apple-signin)
- [Google Sign-In Setup](/authentication/google-signin)
- [Email Sign-In with OTP](/authentication/email-signin)
