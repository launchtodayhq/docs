...
This guide covers the **manual configuration steps** required to set up Google Sign-In. The Launch template includes all the necessary code - you just need to configure Google Cloud Console and understand how the OAuth flow works.
...
4. **Authorized JavaScript origins**: Leave empty (not needed for this flow)
