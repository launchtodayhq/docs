...
- None (this is a reference page)

## Steps

1. Identify the app you’re working on (mobile, API, web)
2. Use the matching section below to navigate folders
3. Jump to the linked deeper‑dive pages
