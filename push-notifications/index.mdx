...
Start with the iOS or Android setup guide to configure credentials and rebuild the app. Once the app is rebuilt, use the onboarding screen to register a device token, then send a test push from your API.

Start here:
- [iOS Setup](/push-notifications/ios)
- [Android Setup](/push-notifications/android)
- [API Setup](/push-notifications/api)
