...
The email system uses [Resend](https://resend.com/) and is already included in
`apps/api/package.json`.

### 2. Configure Environment Variables

Add your Resend API key to your environment variables (copy from
`apps/api/example.env` first):
